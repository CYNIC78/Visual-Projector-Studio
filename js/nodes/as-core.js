...
(function () {
    ...
    const ARG_CATALOG = {
        ...
        '--vae-tiling': { tower: 'loader', key: 'vaeTiling', label: 'VAE Tiling', category: 'hardware', control: 'checkbox', default: false },
        '--vae-conv-direct': { tower: 'loader', key: 'vaeConvDirect', label: 'VAE Direct Conv', category: 'hardware', control: 'checkbox', default: false },
    ...
    function isExpandableArg(def) {
        return !!def && (def.control === 'textarea' || def.control === 'multi-file' || def.control === 'select');
    }
