...
(function () {
    ...
    const Storage = {
        ...
        async getAssetStudioState() { return kvGet('assetStudioState', 'asset-studio', null); },
        async setAssetStudioState(state) { return kvSet('assetStudioState', state, 'asset-studio'); },
